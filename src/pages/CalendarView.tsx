...
const locales = locales = { 'en-US': enUS };
...
export default function CalendarView() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      // 2. Fetch fresh data to ensure we have the correct array
      ...
      alert("Database Error: Could not delete. Did you run the SQL policy in Step 1?");
            ...
            <div className="p-10">
              {isDeleting ? (
                <div className="space-y-6 text-center">
                  <p className="font-bold text-slate-600">Remove interview for <br/><span className="text-rose-600 text-xl font-black underline">{selectedApp?.name}</span>?</p>
                ...
                <div className="space-y-4">
                  <input type="text" placeholder="Search..." className="w-full p-4 bg-slate-50 rounded-2xl font-bold text-sm mb-4 outline-none border focus:border-blue-500" value={searchCandidate} onChange={(e) => setSearchCandidate(e.target.value)} />
